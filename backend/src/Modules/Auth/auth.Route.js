...
const { getlogin, getSignup, postSignup, postlogin, forgotPassword, verifyPassResetCode, resetPassword, getlogout, postlogout } = require('./controller/auth.Controller');
